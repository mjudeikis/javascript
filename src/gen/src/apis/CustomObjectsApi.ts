...
export class CustomObjectsApi extends runtime.BaseAPI {
     ...
     */
    async getAPIResourcesRaw(requestParameters: CustomObjectsApiGetAPIResourcesRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1APIResourceList>> {
        if (requestParameters.group === null || requestParameters.group === undefined) {
     ...
     * get available resources
     */
    async getAPIResources(requestParameters: CustomObjectsApiGetAPIResourcesRequest, initOverrides?: RequestInit): Promise<V1APIResourceList> {
