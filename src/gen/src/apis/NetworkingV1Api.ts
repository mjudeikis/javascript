...
export class NetworkingV1Api extends runtime.BaseAPI {
     ...
     */
    async patchNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiPatchNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * partially update status of the specified NetworkPolicy
     */
    async patchNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiPatchNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<V1NetworkPolicy> {
     ...
     */
    async readNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiReadNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * read status of the specified NetworkPolicy
     */
    async readNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiReadNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<V1NetworkPolicy> {
     ...
     */
    async replaceNamespacedNetworkPolicyStatusRaw(requestParameters: NetworkingV1ApiReplaceNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<V1NetworkPolicy>> {
        if (requestParameters.name === null || requestParameters.name === undefined) {
     ...
     * replace status of the specified NetworkPolicy
     */
    async replaceNamespacedNetworkPolicyStatus(requestParameters: NetworkingV1ApiReplaceNamespacedNetworkPolicyStatusRequest, initOverrides?: RequestInit): Promise<V1NetworkPolicy> {
